...
# Output filenames (in data folder)
OUTPUT_FILES = {
    "en": "data/actions_en.json",
    "ja": "data/actions_ja.json",
    "de": "data/actions_de.json",
    "fr": "data/actions_fr.json",
    "zhtw": "data/actions_zhtw.json",
}
